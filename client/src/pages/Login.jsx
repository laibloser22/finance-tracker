...
function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        setError('')
        try {
            const res = await fetch('https://finance-tracker-api-xy6e.onrender.com/api/auth/login', {
                method: 'POST',
    ...
    return (
      ...
      `,
            ...
            {/* Floating orbs */}
            <div style={{ position: 'fixed', top: '10%', left: '10%', width: '300px', height: '300px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(99,102,241,0.12) 0%, transparent 70%)', animation: 'float 6s ease-in-out infinite', pointerEvents: 'none' }} />
            <div style={{ position: 'fixed', bottom: '10%', right: '10%', width: '250px', height: '250px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(6,182,212,0.1) 0%, transparent 70%)', animation: 'float 8s ease-in-out infinite reverse', pointerEvents: 'none' }} />
            ...
            <div style={{ width: '100%', maxWidth: '440px' }}>
                ...
                <div className="animate-fade-up" style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    ...
                    <h1 style={{ fontSize: '1.8rem', fontWeight: 800, color: '#1e1b4b', marginBottom: '0.25rem' }}>Welcome back</h1>
                    <p style={{ color: '#6b7280', fontWeight: 500 }}>Sign in to your Finance Tracker</p>
                </div>
